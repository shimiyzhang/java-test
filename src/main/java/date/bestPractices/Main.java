...
public class Main {
    public static void main(String[] args) {
        ...
        Instant instantByCalendar = calendar.toInstant();
        ZonedDateTime zonedDateTime = instantByCalendar.atZone(calendar.getTimeZone().toZoneId());
        ...
        cal.clear();
        cal.setTimeZone(TimeZone.getTimeZone(cal.getTimeZone().getID()));
        ...
        long timestamp = 1574208900000L;
        System.out.println(timestampToString(timestamp, Locale.CHINA, "Asia/Shanghai"));
        System.out.println(timestampToString(timestamp, Locale.US, "America/New_York"));
        // 对上述方法进行调用，结果如下：
        //
        // 2019年11月20日 08:15
        // Nov 19, 2019, 7:15 PM
