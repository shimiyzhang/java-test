package encryptAndSafety.encodeAlgorithm;
...
public class Main {
    public static void main(String[] args) {
        ...
        // D	    0x44
        // …	    …
        // 因为ASCII编码最多只能有128个字符，要想对更多的文字进行编码，就需要用Unicode。
        ...
        // 但如果URL中包含中文、日文这些非ASCII字符怎么办？不要紧，URL编码有一套规则：
        //
