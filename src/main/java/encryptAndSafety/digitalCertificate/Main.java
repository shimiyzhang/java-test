package encryptAndSafety.digitalCertificate;
...
public class Main {
    public static void main(String[] args) throws Exception {
        // 我们知道，摘要算法用来确保数据没有被篡改，非对称加密算法可以对数据进行加解密，签名算法可以确保数据完整性和抗否认性，
        ...
        // 开发的时候，我们可以使用自签名的证书，这种证书可以正常开发调试，但不能对外作为服务使用，因为其他客户端并不认可未经CA签名的证书。
        //
        ...
        //
        // keytool -storepass 123456 -genkeypair -keyalg RSA -keysize 1024 -sigalg SHA1withRSA -validity 3650
        ...
        System.out.printf("signature: %x%n", new BigInteger(1, sign));
        // 验证签名:
        ...
        // 如果CA证书的私钥泄漏，那么该CA证书签发的所有证书将不可信。数字证书服务商DigiNotar就发生过私钥泄漏导致公司破产的事故。
    }
