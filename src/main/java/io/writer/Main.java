...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        try (CharArrayWriter writerCharArray = new CharArrayWriter()) {
            writerCharArray.write(65);
            writerCharArray.write(66);
            writerCharArray.write(67);
            char[] charArray = writerCharArray.toCharArray();
        ...
        try (Writer writerStreamAutoClose = new OutputStreamWriter(new FileOutputStream("readme.txt"))) {
            writerStreamAutoClose.write('H');
        }
